...
function App() {
  ...
  return (
    <div className="app-container">
      <header className="header app-header-mobile">
        <div className="app-title-container">
          <h1 className="title" style={{ margin: 0 }}>Global Markets Dashboard</h1>
          <p className="subtitle" style={{ marginTop: '0.5rem' }}>Real-time Analytics - Drag & Drop to Reorder</p>
        </div>
        <div className="app-header-buttons" style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
          <button 
